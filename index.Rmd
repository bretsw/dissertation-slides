...
- PLNs are rooted in *situated* theories of learning

--

- Emphasis on belonging: community membership and apprenticeship 
...
- New teachers' support systems &mdash; the full scope of them &mdash; matter 

--

- Goal of this study is to make recommendations to new teachers and those who support them
...
--
  ...
  - **Teaching during a pandemic** is especially hard

--

  - **Teaching during induction** is... 
...
**Purpose:** Explore the **support systems** new teachers construct during induction and how they use **social media** toward this end

--

So, I talked to new teachers:
...
- Distinct backgrounds and experiences: specialists, itinerants, starting mid-year
...
- **Pilot interviews:** develop interview protocol (*n* = 4)

--

- **Main interviews:** semi-structured interviews to saturation (*n* = 9)
...
- Differences in support systems (PLNs) explained in part by **ecology**

--

- Interconnected and mutually influential pieces
...
- Increased number of available tools, people, and spaces 

--

- This means increased demands on time and agency

---

# Implications for New Teachers

```{r, out.width = "240", echo = FALSE, fig.align = "center"}
include_graphics("img/juxtaposition.jpg")
```
...
- **Context collapse:** Disparate pieces of new teachers' lives coming together in potentially undesirable ways 

--

- **Social comparison:** More feelings of competition than collaboration 
  
--

Other new teachers are also looking for a break, or a place free from scrutiny
...
- Help normalize *legitimate peripheral participation* (observing)
...
Especially for new teachers' support systems: **"I feel like I filled a lot of gaps..."**
